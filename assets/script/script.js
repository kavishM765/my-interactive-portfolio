...
const pageContent = {
    mainGrid: `<div class="glass-card col-span-1 md:col-span-2 xl:col-span-3 flex flex-col sm:flex-row items-center gap-6"><img src="./assets/image/imgone.jpg" alt="Kavish M" class="w-28 h-28 md:w-36 md:h-36 object-cover rounded-full border-2 border-blue-400 flex-shrink-0"><div><h2 class="text-2xl lg:text-3xl font-bold">Kavish M</h2><p class="text-gray-300">B.Tech IT Student @ SNS College of Technology</p><p class="mt-2 text-gray-400">IT Student | Agentic AI & Low-Code Automation (n8n) | AI  with Streamlit | Web Dev: HTML, CSS, JS | Java, Python|#OpenToWork</p></div></div>` +
