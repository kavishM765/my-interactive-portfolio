// Optimized Modal Templates for Recruiters
const templates = {
    email: `
        ...
        <form action="https://formspree.io/f/xeozngwn" method="POST" class="space-y-4">
            ...
            <div class="flex justify-end gap-3 pt-4">
                ...
                <button type="submit" class="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold hover:shadow-lg transition">Send Inquiry</button>
            </div>
        </form>`,
    phone: `
