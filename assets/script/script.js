...
const templates = {
    ...
    // UPDATED: Phone modal now clearly displays the number.
    phoneModal: `<div class="glass-card modal-content text-center">
                    <div id="phone-initial-view">
                        <h2 class="text-xl font-bold mb-2">Contact Kavish M</h2>
                        <p class="mb-4 text-gray-300">My phone number is:</p>
                        <p class="text-2xl font-bold text-white tracking-widest bg-black/20 rounded-lg py-2 mb-4">+91 9865824929</p>
                        <p class="mb-4 text-gray-400 text-sm">You can tap a button below to start a call on a compatible device.</p>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <button onclick="handleCall('work')" class="btn-primary">Call (Work)</button>
                            <button onclick="handleCall('personal')" class="btn-secondary px-4 py-2 rounded-lg">Personal</button>
                            <button onclick="handleCall('other')" class="btn-primary">Call (Other)</button>
                        </div>
                    </div>
                    <div id="phone-personal-message" class="hidden">
                        <h2 class="text-xl font-bold mb-2">Thank you!</h2>
                        <p class="text-gray-300">For personal matters, please connect with me via Email or LinkedIn. Thank you for your understanding.</p>
                        <button onclick="closeAllModals()" class="btn-primary mt-4">Got it</button>
                    </div>
                 </div>`
};
