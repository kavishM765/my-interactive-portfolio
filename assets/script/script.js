...
// This has now been updated with your personal Firebase keys.
...
// --- CONTENT TEMPLATES ---
const templates = {
    login: `<div class="w-full max-w-md space-y-4 text-center p-4">
                <div id="auth-container" class="glass-card p-6 md:p-8 space-y-4 text-left">
                    <!-- This content will be changed by JS -->
                </div>
                <p id="auth-error" class="text-red-400 text-sm h-4"></p>
            </div>`,
    signUpForm: `<h1 class="text-3xl font-black text-white text-center">Create an Account</h1>
                 <form id="signup-form">
                    <div><label for="signup-name" class="block text-sm font-medium text-gray-300">Your Name</label><input type="text" id="signup-name" placeholder="e.g., Sundar Pichai" class="form-input mt-1" required></div>
                    <div><label for="signup-location" class="block text-sm font-medium text-gray-300">Where are you from?</label><input type="text" id="signup-location" placeholder="e.g., Mountain View, CA" class="form-input mt-1" required></div>
                    <div><label for="signup-email" class="block text-sm font-medium text-gray-300">Your Email</label><input type="email" id="signup-email" placeholder="e.g., sundar@google.com" class="form-input mt-1" required></div>
                    <div><label for="signup-password" class="block text-sm font-medium text-gray-300">Create a Password</label><input type="password" id="signup-password" placeholder="••••••••" class="form-input mt-1" required></div>
                    <button type="submit" class="w-full btn-primary">Sign Up & Explore</button>
                 </form>
                 <p class="text-xs text-center text-gray-400">Already have an account? <span onclick="toggleAuthForm('signin')" class="font-bold text-blue-300 cursor-pointer">Sign In</span></p>`,
    signInForm: `<h1 class="text-3xl font-black text-white text-center">Welcome Back!</h1>
                 <form id="signin-form">
                    <div><label for="signin-email" class="block text-sm font-medium text-gray-300">Your Email</label><input type="email" id="signin-email" placeholder="e.g., sundar@google.com" class="form-input mt-1" required></div>
                    <div><label for="signin-password" class="block text-sm font-medium text-gray-300">Password</label><input type="password" id="signin-password" placeholder="••••••••" class="form-input mt-1" required></div>
                    <button type="submit" class="w-full btn-primary">Sign In</button>
                 </form>
                 <p class="text-xs text-center text-gray-400">Don't have an account? <span onclick="toggleAuthForm('signup')" class="font-bold text-blue-300 cursor-pointer">Sign Up</span></p>`,
